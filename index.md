...
* **`Wentao Xu`**<sup>**`*`**</sup>, Kazutoshi Sasahara, Jianxun Chu, Bin Wang, Wenlu Fan, Zhiwen Hu<sup>**`*`**</sup>, Social Media Warfare: Investigating Human-Bot Engagement in English, Japanese and German during the Russo-Ukrainian War on Twitter and Reddit, **`EPJ Data Science`** (accepted)
