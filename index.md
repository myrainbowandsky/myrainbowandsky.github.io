...
# News
* Yan, Yile, Yuqi Zhu, Wentao Xu. "Bias in Decision-Making for AI's Ethical Dilemmas: A Comparative Study of ChatGPT and Claude." [arXiv:2501.10484, 2025](https://arxiv.org/abs/2501.10484).
* Xu, Wentao, Kazutoshi Sasahara, Jianxun Chu, Bin Wang, Wenlu Fan, Zhiwen Hu, Social Media Warfare: Investigating Human-Bot Engagement in English, Japanese and German during the Russo-Ukrainian War on Twitter and Reddit, EPJ Data Science (accepted)
* Fan, Wenlu, Yuqi Zhu, Chenyang Wang, Bin Wang, Wentao Xu. "Consistency of Responses and Continuations Generated by Large Language Models on Social Media." [arXiv:2501.08102, 2025](https://arxiv.org/abs/2501.08102).
* Lou, Qianmin, Wentao Xu. "Personality Modeling for Persuasion of Misinformation using AI Agent." [arXiv:2501.08985, 2025](https://arxiv.org/abs/2501.08985).
* Xu, Wentao, Wenlu Fan, Shiqian Lu, Tenghao Li, Bin Wang. "Polarized Patterns of Language Toxicity and Sentiment of Debunking Posts on Social Media." [arXiv:2501.06274, 2025](https://arxiv.org/abs/2501.06274).
...
* Xu, Wentao, Kazutoshi Sasahara, Jianxun Chu, Bin Wang, Wenlu Fan, Zhiwen Hu. "A multidisciplinary framework for deconstructing bots' pluripotency in dualistic antagonism." [arXiv:2402.15119, 2024](https://arxiv.org/abs/2402.15119).
* Xu, Wentao, Kazutoshi Sasahara. "Domain-based user embedding for competing events on social media." [arXiv:2308.14806, 2023](https://arxiv.org/abs/2308.14806).
